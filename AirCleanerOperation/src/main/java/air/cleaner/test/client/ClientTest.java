...
public class ClientTest extends Thread{
	...
	public void run() {
	    ...
	    while(true){
			...
			byte[] UID = new byte[]{0x15,-0x33,0x11,0x11,0x11,0x22,0x00,0x00,0x22,0x00,0x00,0x01};
			byte[] LEN = new byte[]{0x20};
			byte[] DATA = new byte[]{0x00,0x02,0x33,0x22,0x11,0x11,0x11,0x11,0x11,0x11,0x01,0x01,0x01,0x01};
			byte[] reserve = new byte[]{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
